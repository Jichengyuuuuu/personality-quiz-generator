...
<table>
  <tr>
    ...
    <td width="50%">
      <img src="./assets/showcase/conflict-instinct-quiz.jpg" alt="Conflict instinct abstract personality test website generated by Personality Quiz Generator" width="100%">
      <br><strong>What is your instinct during conflict?</strong><br>Abstract personality test · Responsive website
    </td>
  </tr>
  <tr>
    <td width="50%">
      <img src="./assets/showcase/pressure-animal-quiz.jpg" alt="Pressure animal archetype personality quiz mobile app generated by Personality Quiz Generator" width="100%">
      <br><strong>Which animal do you become under pressure?</strong><br>Themed archetype quiz · Illustrated mobile app
    </td>
    <td width="50%">
      <img src="./assets/showcase/travel-city-match-quiz.jpg" alt="Best city for slow travel lifestyle matching quiz generated by Personality Quiz Generator" width="100%">
